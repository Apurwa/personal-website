    ...
    <main className="max-w-4xl mx-auto px-6 py-12">
      ...
      <section className="mb-16 animate-fade-in-up delay-3">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <StatDisplay
            value={`₹${data.overview.grossTaxRevenue}L Cr`}
          ...
          />
          <StatDisplay
            value={`${data.overview.taxpayersFiling} Cr`}
            label="ITR Filers"
            sublabel="Returns filed"
          />
          <StatDisplay
            value={`${data.overview.gstRegistrations} Cr`}
      ...
      <section className="mb-16">
        ...
        <div className="grid grid-cols-2 gap-4 mt-8">
          <StatDisplay
            value={`₹${data.corporateTax.collection.fy2024}L Cr`}
      ...
      <section className="mb-16">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 my-8">
          <StatDisplay
            value={`₹${data.gst.collection.fy2024Total}L Cr`}
            label="FY24 Collection"
            sublabel="Total GST"
          />
          <StatDisplay
            value={`₹${data.gst.collection.monthlyAverage}L Cr`}
            label="Monthly Average"
            sublabel="Current year"
          />
          <StatDisplay
            value={`₹${data.gst.collection.highestEver}L Cr`}
            label="Record High"
            sublabel={data.gst.collection.highestMonth}
          />
          <StatDisplay
            value={data.gst.taxesReplaced.length.toString()}
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-4 mb-8">
          {data.gst.slabs.map((slab) => (
            <ContentCard key={slab.rate} className="text-center">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          {data.gst.types.map((type) => (
            <ContentCard key={type.type}>
      ...
      <section className="mb-16">
        ...
        <div className="space-y-4">
          {data.taxReforms.map((reform) => (
            <ContentCard key={reform.year}>
      ...
      <section className="mb-16">
        ...
        <div className="space-y-3">
          {data.blackMoney.governmentMeasures.map((measure) => (
            <ContentCard key={measure.measure}>
